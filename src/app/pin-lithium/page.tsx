...
const itemsData = [
  {
    title: 'Pin lưu trữ Lithium Goodwe',
    path: '/hybrid-mot-pha',
  ...
  {
    title: 'Pin lưu trữ Lithium Growatt',
    path: '/hybrid-mot-pha',
    icon: <ThunderboltOutlined style={{ color: 'orange', fontSize: '40px', position: 'absolute', top: '50%', left: '50%', translate: '-50% -50%' }} />,
    expert: 'Giới thiệu nhãn hàng',
  ...
  {
    title: 'Pin lưu trữ Lithium Gigabox',
    path: '/hybrid-mot-pha',
    icon: <ThunderboltOutlined style={{ color: 'orange', fontSize: '40px', position: 'absolute', top: '50%', left: '50%', translate: '-50% -50%' }} />,
    expert: 'Giới thiệu nhãn hàng',
...
export default function PinLithium() {
          ...
          <Row style={{ position: 'relative' }}>
            ...
            <Col style={{
              ...
              <div style={{ position: 'absolute', top: 0, left: '50%', translate: '-50% 0%', width: '100%', height: '600px' }}>
                <Typography.Title style={{ position: 'absolute', top: '100px', left: '50%', translate: '-50% -50%', width: '100%', textTransform: 'uppercase', color: '#fff' }} level={3}>Pin Lithium</Typography.Title>
