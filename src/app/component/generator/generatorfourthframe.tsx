...
const comboOneFeatureData =
{
    ...
    price: <>96,000,000 <Image src='/img/dong-icon.svg' alt="vnd" width={18} height={18} /></>,
...
const comboTwoFeatureData =
{
    ...
    title: 'Tấm pin mặt trời',
    feature1: 'Thương hiệu Pin top 3 thế giới',
    feature2: 'Inverter Hybrid 11kW 3 pha',
    feature3: 'Pin Lithium FePO4 5kWh',
    price: <>170,000,000 <Image src='/img/dong-icon.svg' alt="vnd" width={18} height={18} /></>,
}
...
export default Generatorfourthframe;
