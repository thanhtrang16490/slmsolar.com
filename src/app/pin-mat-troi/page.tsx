...
export default function PinMatTroi() {
          ...
          <Row style={{ position: 'relative' }}>
            ...
            <Col style={{
              ...
              <div style={{ position: 'absolute', top: 0, left: '50%', translate: '-50% 0%', width: '100%', height: '600px' }}>
                <Typography.Title style={{ position: 'absolute', top: '100px', left: '50%', translate: '-50% -50%', width: '100%', textTransform: 'uppercase', color: '#fff' }} level={3}>Pin mặt trời</Typography.Title>
                <Typography.Title style={{ position: 'absolute', top: '150px', left: '50%', translate: '-50% -50%', width: '300px', fontSize: '14px', color: '#fff', fontWeight: 300 }} level={5}>Pin quang năng</Typography.Title>
              </div>
            </Col>
